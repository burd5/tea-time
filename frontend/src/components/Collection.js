...
function Collection() {
  ...
  <div className="collections">
    ...
    <div>
    <div>
    {isLoading === true ? <Box sx={{ display: 'flex', justifyContent: 'center', margin: 'auto', marginTop: 10, height: 500  }}><CircularProgress size="10rem" sx={{ color: 'rgb(60, 11, 69)'}}/></Box> : <div></div>}
    </div>
